...
addsent_file = os.path.join(home, "data", "squad", "sample1k-HCVerifyAll.json")
addonesent_file = os.path.join(home, "data", "squad", "sample1k-HCVerifyAll.json.dot")
...
addsent_record_file = os.path.join(target_dir, "sample1k-HCVerifyAll.tfrecords")
addonesent_record_file = os.path.join(target_dir, "sample1k-HCVerifySample.tfrecords")
word_emb_file = os.path.join(target_dir, "word_emb.json")
char_emb_file = os.path.join(target_dir, "char_emb.json")
train_eval = os.path.join(target_dir, "train_eval.json")
dev_eval = os.path.join(target_dir, "dev_eval.json")
test_eval = os.path.join(target_dir, "test_eval.json")
addsent_eval = os.path.join(target_dir, "sample1k-HCVerifyAll_eval.json")
addonesent_eval = os.path.join(target_dir, "sample1k-HCVerifySample_eval.json")
dev_meta = os.path.join(target_dir, "dev_meta.json")
test_meta = os.path.join(target_dir, "test_meta.json")
addsent_meta = os.path.join(target_dir, "sample1k-HCVerifyAll_meta.json")
addonesent_meta = os.path.join(target_dir, "sample1k-HCVerifySample_meta.json")
...
flags.DEFINE_string("addsent_file", addsent_file, "")
flags.DEFINE_string("addonesent_file", addonesent_file, "")
...
flags.DEFINE_string("addsent_eval_file", addsent_eval, "")
flags.DEFINE_string("addonesent_eval_file", addonesent_eval, "")
flags.DEFINE_string("dev_meta", dev_meta, "")
flags.DEFINE_string("test_meta", test_meta, "")
flags.DEFINE_string("addsent_meta", addsent_meta, "")
flags.DEFINE_string("addonesent_meta", addonesent_meta, "")
...
def main(_):
    ...
    if config.mode == "train":
        ...
        test(config)
    elif config.mode == "addsent":
        test(config, dataset="addsent")
    elif config.mode == "addonesent":
        test(config, dataset="addonesent")
    else:
        print("Unknown mode")
        exit(0)
